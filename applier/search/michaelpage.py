...
_BASE = "https://www.michaelpage.fr"
...
_HEADERS = {
    ...
    "Referer": "https://www.michaelpage.fr/",
}


class MichaelPageSearcher(BaseSearcher):
    def search(self, keywords: str, location: str, count: int = 50) -> list[JobResult]:
        ...
        cards = (
            soup.select(".job-search-result__item")
        ...
        for card in cards[:count]:
            ...
            company = company_el.get_text(strip=True) if company_el else "Michael Page"
