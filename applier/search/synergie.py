...
_BASE = "https://www.synergie.fr"
_SEARCH = f"{_BASE}/candidats/offres-d-emploi"
_HEADERS = {
...
class SynergieSearcher(BaseSearcher):
    def search(self, keywords: str, location: str, count: int = 50) -> list[JobResult]:
        params = {"keyword": keywords, "location": location}
        try:
            resp = httpx.get(
        ...
        for card in cards[:count]:
            ...
            company = company_el.get_text(strip=True) if company_el else "Synergie"
