...
_BASE = "https://www.hays.fr"
_SEARCH = f"{_BASE}/offres-d-emploi"
_HEADERS = {
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 "
                  "(KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",
    "Accept-Language": "fr-FR,fr;q=0.9",
    "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
    "Referer": "https://www.hays.fr/",
}


class HaysSearcher(BaseSearcher):
    def search(self, keywords: str, location: str, count: int = 50) -> list[JobResult]:
        params = {"keywords": keywords, "location": location, "radius": "20"}
        try:
            resp = httpx.get(
        ...
        for card in cards[:count]:
            ...
            company = company_el.get_text(strip=True) if company_el else "Hays"
